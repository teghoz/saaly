...
{
    public class AuditEntityJobTrigger : IAfterSaveTrigger<EntityJob>
    {
        readonly SaalyContext _context;
        public AuditEntityJobTrigger(SaalyContext context)
        {
            _context = context;
        }

        public async Task AfterSave(ITriggerContext<EntityJob> context, CancellationToken cancellationToken)
        {
            var audit = new AuditEntityJob
            {
                IsActive = true,
                ...
                EntityJobGuid = context.Entity.Guid,
            ...
            await _context.AuditEntityJobs.AddAsync(audit);
            await _context.SaveChangesAsync();
        }

        public void AfterSave(ITriggerContext<EntityJob> context)
        {
