...
{
    public class AuditEntityLocationTrigger : IAfterSaveTrigger<EntityLocation>
    {
        readonly SaalyContext _context;
        public AuditEntityLocationTrigger(SaalyContext context)
        {
            _context = context;
        }

        public async Task AfterSave(ITriggerContext<EntityLocation> context, CancellationToken cancellationToken)
        {
            var audit = new AuditEntityLocation
            {
                IsActive = true,
                ...
                EntityLocationGuid = context.Entity.Guid,
            ...
            await _context.AuditEntityLocations.AddAsync(audit);
            await _context.SaveChangesAsync();
        }

        public void AfterSave(ITriggerContext<EntityLocation> context)
        {
