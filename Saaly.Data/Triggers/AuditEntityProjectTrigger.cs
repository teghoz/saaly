...
{
    public class AuditEntityProjectTrigger : IAfterSaveTrigger<EntityProject>
    {
        readonly SaalyContext _context;
        public AuditEntityProjectTrigger(SaalyContext context)
        {
            _context = context;
        }

        public async Task AfterSave(ITriggerContext<EntityProject> context, CancellationToken cancellationToken)
        {
            var audit = new AuditEntityProject
            {
                IsActive = true,
                ...
                EntityProjectGuid = context.Entity.Guid,
            ...
            await _context.AuditEntityProjects.AddAsync(audit);
            await _context.SaveChangesAsync();
        }

        public void AfterSave(ITriggerContext<EntityProject> context)
        {
