...
{
    public class AuditEntityUserGroupUserTrigger : IAfterSaveTrigger<EntityUserGroupUser>
    {
        readonly SaalyContext _context;
        public AuditEntityUserGroupUserTrigger(SaalyContext context)
        {
            _context = context;
        }

        public async Task AfterSave(ITriggerContext<EntityUserGroupUser> context, CancellationToken cancellationToken)
        {
            var audit = new AuditEntityUserGroupUser
            {
                IsActive = true,
                ...
                EntityUserGroupGuid = context.Entity.EntityUserGroupGuid,
                EntityUserGroupUserGuid = context.Entity.EntityUserGroupUserGuid,
            };
            ...
            await _context.AuditEntityUserGroupUsers.AddAsync(audit);
            await _context.SaveChangesAsync();
        }

        public void AfterSave(ITriggerContext<EntityUserGroupUser> context)
        {
